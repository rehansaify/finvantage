      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-finvantage-slate">
            ...
            <Link to="/login" className="font-semibold text-finvantage-accent hover:text-emerald-700 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleRegister}>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-finvantage-navy mb-1.5" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
